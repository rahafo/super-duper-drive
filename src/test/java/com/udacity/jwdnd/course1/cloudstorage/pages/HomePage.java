...
public class HomePage {
    ...
    @FindBy(id = "note-description")
    private WebElement txtUpdateNoteDescription;
    ...
    public void updateNoteTitle(String newNoteTitle) {
    ...
    public void updateNoteDescription(String newNoteDescription) {
        wait.until(ExpectedConditions.elementToBeClickable(txtUpdateNoteDescription)).clear();
        wait.until(ExpectedConditions.elementToBeClickable(txtUpdateNoteDescription)).sendKeys(newNoteDescription);
    }
